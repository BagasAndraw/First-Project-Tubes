...
func main() {
	...
	for {
		...
		fmt.Println("7. Urutkan Riwayat Kendaraan Berdasarkan Durasi Parkir (Selection Sort)")
		fmt.Println("8. Urutkan Histori Berdasarkan Jenis dan Waktu Keluar (Insertion Sort)")
